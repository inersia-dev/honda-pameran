                    ...
                    <form class="card-body" action="">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div>
                                    <a class="btn btn-outline-info" onclick="addRowDana(); return false;" href="#">
                        ...
                        <div class="mb-2 row">
                            <label class="col-sm-2 col-form-label">
                                <strong>Penanggung Jawan</strong>
                            </label>
                            <div class="col-sm-10">
                                <table class="table table-striped border datatable table-sm">
                                    <thead class="text-center">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div>
                                    <a class="btn btn-outline-info" onclick="addRow(); return false;" href="#">
